...
import { LogOut, ShieldCheck, CalendarClock } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <div className="font-display font-extrabold text-sm sm:text-base leading-tight text-slate-900 truncate">
              Si-Scoring Kalteng
            </div>
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          {period && period.name && (
            <div
              ...
              className="hidden md:flex items-center gap-2 px-3 py-1.5 rounded-full bg-accent/10 border border-accent/30 text-accent"
            >
